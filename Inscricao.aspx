            ...
            <div id="divDadosPessoais" class="bloco">
                ...
                <div id="divPagina1" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-xs-7">
                            <asp:TextBox ID="txtNaturalidade" runat="server" CssClass="form-control" MaxLength="60"></asp:TextBox>
                        </div>
                        <div class="col-md-1 col-xs-5">
                            <asp:TextBox ID="txtUFNaturalidade" runat="server" CssClass="form-control" MaxLength="2"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-xs-12 text-left">
