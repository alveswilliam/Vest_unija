...
//Antiga máscara: atende somente telefones no formato de 8 dígitos
...
//Formata telefones com 8 e 9 dígitos: (xx) 0000-0000 e (00) ?0000-0000
...
function validaData(obj) {
    ...
    if (!patternValidaData.test(ob.value)) {
        alert("Data inválida ou em formato incorreto.");
        ob.value = "";
        return false;
    }
}
